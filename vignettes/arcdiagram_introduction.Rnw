...
<<lab_arcdiagram_ex5, fig.width=4, fig.height=6, out.width='.65\\linewidth', out.height='.65\\linewidth', fig.align='center', echo=c(1,3), tidy=FALSE>>=
